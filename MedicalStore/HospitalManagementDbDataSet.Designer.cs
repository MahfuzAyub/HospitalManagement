...
namespace MedicalStore.HospitalManagementDbDataSetTableAdapters {
    ...
    public partial class GenderTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Gender] WHERE (([GenderId] = @Original_GenderId) AND ([Gender]" +
                " = @Original_Gender))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Gender] ([Gender]) VALUES (@Gender);\r\nSELECT GenderId, Gender " +
                "FROM Gender WHERE (GenderId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Gender] SET [Gender] = @Gender WHERE (([GenderId] = @Original_Gende" +
                "rId) AND ([Gender] = @Original_Gender));\r\nSELECT GenderId, Gender FROM Gender WH" +
                "ERE (GenderId = @GenderId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT GenderId, Gender FROM dbo.Gender";
        ...
        public virtual int Fill(HospitalManagementDbDataSet.GenderDataTable dataTable) {
        ...
        public virtual HospitalManagementDbDataSet.GenderDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            HospitalManagementDbDataSet.GenderDataTable dataTable = new HospitalManagementDbDataSet.GenderDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(HospitalManagementDbDataSet.GenderDataTable dataTable) {
